...
#                                                                last_epoch=-1)
        ...
        for epoch_counter in range(self.config['epochs']):
            print('Epoch {}/{}'.format(epoch_counter, self.config['epochs']))
            ...
            if epoch_counter % self.config['eval_every_n_epochs'] == 0:
                ...
                if valid_loss < best_valid_loss:
                    ...
                    print('saved to ', model_checkpoints_folder)
    ...
    def _load_pre_trained_weights(self, model):
        try:
            ...
            state_dict = torch.load(os.path.join(checkpoints_folder, 'model_5x.pth')) # edit appropriately
